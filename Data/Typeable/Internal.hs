...
sameTypeRep (TyC c1) (TyC c2) = c1 == c2
sameTypeRep (TyA t11 t12) (TyA t21 t22) = t11 `sameTypeRep` t21 && t12 `sameTypeRep` t22
sameTypeRep (TyF t11 t12) (TyF t21 t22) = t11 `sameTypeRep` t21 && t12 `sameTypeRep` t22
sameTypeRep _ _ = False
...
--   | Fingerprint (W# hi) (W# lo) <- fingerprint
